<template>
  <form v-on:submit.prevent="submitForm">
    <div class="form-control" v-bind:class="{invalid : userNameValidity === 'invalid'}">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="username" v-on:blur="validateInput"/>
      <p v-if="userName === 'invalid'">Please re input</p>
    </div>
    ...
    <condition v-model="rating"></condition>
    <div>
